...
const logoutUrl = config.apiGatewayUri + '/manager/logout?accessToken={accessToken}&refreshToken={refreshToken}'
...
function openGatewayLogin (clientId, redirectUri) {
  var url = '/oauth/authorise?client_id={client_id}&redirect_uri={redirect_uri}'
